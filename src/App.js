...
function App() {
  ...
  // Exercice 3 : Troisième useState pour le compteur
  ...
  // Exercice 3 : Fonction pour mettre à jour la recherche ET le compteur
  ...
  return (
    <div className="App">
      ...
      <main className="contenu">
        ...
        <p style={{ fontWeight: 'bold', color: '#0a6e31' }}>
          Vous avez effectué {compteurRecherche} recherche(s)
        </p>

        {/* Passage de la nouvelle fonction handleRechercheChange */}
